...
const EditEmployees = ({ employee, api }) =>{
        ...
        const [position, setPostion] = useState(employee.position);
        const [employmentDate, setEmploymentDate] = useState(() => formatDate(employee.employment_date));
                    ...
                    <div className="flex flex-col gap-8 items-center">
                        ...
                        <div className="flex flex-col w-64 gap-5">
                            ...
                            <Input
                                ...
                                color="white" type="name" required placeholder="eg. admin" label="Position" 
                                className="placeholder-blue-gray-400 appearance-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none" />
                            ...
                            <Input 
                                ...
                                color='white' type="number" required inputMode="numeric" placeholder="eg. 8,000" label="Salary" 
                                className="placeholder-blue-gray-400 appearance-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none" />
                            <Input type="date"
                                id="employmentDate"
                                value={employmentDate}
                                onChange={(e) => setEmploymentDate(e.target.value)}
                                color='white' required label="Employment Date" inputMode="none"
                                className="placeholder-blue-gray-400 appearance-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"/>

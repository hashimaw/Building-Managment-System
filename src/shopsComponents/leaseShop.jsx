                ...
                <form onSubmit={handleSubmit}>
                    <div className="flex flex-col gap-8 items-center">
                        ...
                        <div className="flex flex-col w-64 gap-5">
                            <Select color='white' label="Select Tenant" className=" placeholder-blue-gray-400 text-white" 
                                ...
                                <Option 
                                    ...
                                    {`${tenant.first_name} ${tenant.last_name}`} {tenant.shop_id && " - " + tenant.shop_id }
                                </Option>
                                ))}
                            </Select>
                            <Input type="date"
                        ...
                        <div className="self-start -mb-4 flex justify-evenly w-full">
                            <div className="flex gap-3"> 
                                <p>Total Amount:</p>
                                <p className="text-gray-200">{shop.price*duration}</p>
                            </div>
                        </div>
                        </div>
